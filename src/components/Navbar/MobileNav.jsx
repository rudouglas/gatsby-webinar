        ...
        <FocusLock disabled={!show} returnFocus>
          ...
          >
            <Box pt="5" pb="6" px="5">
              ...
              >
                <NavLink.Mobile icon={AiFillHome}>Home</NavLink.Mobile>

                <NavLink.Mobile icon={AiOutlineInfo}>About</NavLink.Mobile>

                <NavLink.Mobile icon={BsFillPeopleFill}>Characters</NavLink.Mobile>
